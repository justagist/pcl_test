...
namespace aml_pcloud
{
    ...
    sensor_msgs::PointCloud::Ptr PclRosConversions::ROSMsgFromPclCloud(PointCloud& cloud)
    {
        // ----- sensor_msgs::PointCloud2 is required for conversions from and to pcl pointclouds
        sensor_msgs::PointCloud2 msg_pc2;
    ...
    // may cause seg fault with ROS PCL
    PointCloudPtr PCLProcessor::downsamplePcdFile(const PointCloudPtr cloud)
    {

        pcl::PCLPointCloud2::Ptr cloud_filtered_pc2;
